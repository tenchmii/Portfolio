...
const Contact = () => {
  ...
  return (
    <div className="flex justify-center min-h-screen w-full p-8">
      ...
      >
        <p className="mt-10 sm:text-[18px] text-[14px] text-secondary uppercase tracking-wide text-center text-white">
          Contactez-moi.
        </p>
        <h2 className="font-black md:text-[60px] sm:text-[50px] xs:text-[40px] text-[30px] text-center text-white">
          Contact
        </h2>
        ...
        >
          ...
          <label className="flex flex-col w-full">
            <span className="font-medium mb-2">Votre Mail</span>
            <input
              type="email"
              name="email"
              value={form.email}
